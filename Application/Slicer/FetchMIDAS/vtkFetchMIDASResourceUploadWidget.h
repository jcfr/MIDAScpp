#ifndef __vtkFetchMIDASResourceUploadWidget_h
#define __vtkFetchMIDASResourceUploadWidget_h
...
class VTK_FETCHMIDAS_EXPORT vtkFetchMIDASResourceUploadWidget : public vtkFetchMIDASMulticolumnWidget
{
  
public:
  static vtkFetchMIDASResourceUploadWidget* New();
  vtkTypeRevisionMacro(vtkFetchMIDASResourceUploadWidget,vtkFetchMIDASMulticolumnWidget);
 ...
 protected:
  vtkFetchMIDASResourceUploadWidget();
  virtual ~vtkFetchMIDASResourceUploadWidget();
  ...
  vtkFetchMIDASResourceUploadWidget(const vtkFetchMIDASResourceUploadWidget&); // Not implemented
  void operator=(const vtkFetchMIDASResourceUploadWidget&); // Not Implemented
};
