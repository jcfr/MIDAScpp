#ifndef __vtkFetchMIDASLogic_h
#define __vtkFetchMIDASLogic_h
...
class VTK_FETCHMIDAS_EXPORT vtkFetchMIDASLogic : public vtkSlicerModuleLogic
{
  public:
  static vtkFetchMIDASLogic *New();
  vtkTypeMacro(vtkFetchMIDASLogic,vtkSlicerModuleLogic);
  ...
  virtual void SetFetchMIDASNode( vtkMRMLFetchMIDASNode *node );

  // Description:
  // Get/Set on collection of web services
  vtkGetObjectMacro ( ServerCollection, vtkFetchMIDASServerCollection );

  // Description:
  // Get/Set on the currently selected web service
  vtkGetObjectMacro ( CurrentWebService, vtkFetchMIDASServer );
  vtkSetObjectMacro ( CurrentWebService, vtkFetchMIDASServer );
  ...
  // Description:
  //Get/Set MRML node storing parameter values
  void SetAndObserveFetchMIDASNode(vtkMRMLFetchMIDASNode *n) 
    {
    vtkSetAndObserveMRMLNodeMacro( this->FetchMIDASNode, n);
    }
  ...
  // into the FetchMIDASNode's tagtable with default values (used for resource query and markup),
  ...
  // selected in the FetchMIDASNode.
  ...
  // this method fills up the FetchMIDASNode's XNDTagTable (for resource query and markup)
 ...
 // Description:
  ...
  /// Return a pointer on the RestAPI instance.
  RestAPI* GetRestAPI() { return this->rest; };
  void SetFRW(vtkFetchMIDASFlatResourceWidget *f){ this->frw = f; }
  vtkFetchMIDASFlatResourceWidget* GetFRW() { return this->frw; }

 protected:
  vtkFetchMIDASLogic();
  ~vtkFetchMIDASLogic();
  vtkFetchMIDASLogic(const vtkFetchMIDASLogic&);
  void operator=(const vtkFetchMIDASLogic&);

  vtkFetchMIDASServerCollection *ServerCollection;
  vtkFetchMIDASServer *CurrentWebService;
  ...
  RestAPI *rest;
  vtkFetchMIDASFlatResourceWidget *frw;
};
