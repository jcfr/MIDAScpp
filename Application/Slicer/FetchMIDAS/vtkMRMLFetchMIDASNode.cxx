...
//------------------------------------------------------------------------------
vtkCxxRevisionMacro ( vtkMRMLFetchMIDASNode, "$Revision$");
...
//------------------------------------------------------------------------------
vtkMRMLFetchMIDASNode* vtkMRMLFetchMIDASNode::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLFetchMIDASNode");
  if(ret)
    {
      return (vtkMRMLFetchMIDASNode*)ret;
    }
  // If the factory was unable to create the object, then create it here.
  return new vtkMRMLFetchMIDASNode;
}

//----------------------------------------------------------------------------

vtkMRMLNode* vtkMRMLFetchMIDASNode::CreateNodeInstance()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLFetchMIDASNode");
  if(ret)
...
//----------------------------------------------------------------------------
vtkMRMLFetchMIDASNode::vtkMRMLFetchMIDASNode()
{
  this->SingletonTag = const_cast<char *>("vtkMRMLFetchMIDASNode");
...
//----------------------------------------------------------------------------
void vtkMRMLFetchMIDASNode::AddTagTablesForWebServices ( )
{
...
//----------------------------------------------------------------------------
void vtkMRMLFetchMIDASNode::WriteXML(ostream& of, int nIndent)
{
/*
...
//----------------------------------------------------------------------------
void vtkMRMLFetchMIDASNode::ReadXMLAttributes(const char** atts)
{
/*
  // cout << "vtkMRMLFetchMIDASNode::ReadXMLAttributes(const char** atts)" << endl;
...
//----------------------------------------------------------------------------
void vtkMRMLFetchMIDASNode::SetServer ( const char *s)
{
  if (s == NULL)
    {
  ...
  this->InvokeEvent ( vtkMRMLFetchMIDASNode::SelectedServerModifiedEvent );
}



//----------------------------------------------------------------------------
void vtkMRMLFetchMIDASNode::SetServiceType ( const char *s)
{
...
//----------------------------------------------------------------------------
void vtkMRMLFetchMIDASNode::RaiseErrorEvent ()
{
  this->InvokeEvent ( vtkMRMLFetchMIDASNode::RemoteIOErrorEvent );
}



//----------------------------------------------------------------------------
void vtkMRMLFetchMIDASNode::RaiseErrorChoice ()
{
  this->InvokeEvent ( vtkMRMLFetchMIDASNode::RemoteIOErrorChoiceEvent );
}
...
void vtkMRMLFetchMIDASNode::Copy(vtkMRMLNode *anode)
{
  Superclass::Copy(anode);
  vtkMRMLFetchMIDASNode *node = (vtkMRMLFetchMIDASNode *) anode;
...
//----------------------------------------------------------------------------
void vtkMRMLFetchMIDASNode::PrintSelf(ostream& os, vtkIndent indent)
{
