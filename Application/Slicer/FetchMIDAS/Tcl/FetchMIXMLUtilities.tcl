...
#----------------------------------------------------------------------------------------------------
#--- NO LONGER USED. moved to FetchMIDASLogic's Writer
#----------------------------------------------------------------------------------------------------
proc FetchMIDASWriteDocumentDeclaration_XND { filename } {
...
#--- NO LONGER USED. moved to FetchMIDASLogic's Writer
#----------------------------------------------------------------------------------------------------
proc FetchMIDASWriteXMLHeader_XND { headerFilename  dataFilename } {
...
#--- NO LONGER USED. moved to FetchMIDASLogic's Writer
#----------------------------------------------------------------------------------------------------
proc FetchMIDASWriteMetadataForScene_XND {  metadataFilename docdecFilename } {

    set fgui  $::slicer3::FetchMIDASGUI
...
#--- NO LONGER USED. moved to FetchMIDASLogic's Writer
#----------------------------------------------------------------------------------------------------
proc FetchMIDASWriteMetadataForNode_XND { metadataFilename docdecFilename nodeID } {
...
#----------------------------------------------------------------------------------------------------
#--- NO LONGER USED. moved to FetchMIDASLogic's Parser
#----------------------------------------------------------------------------------------------------
proc FetchMIDASParseMetadataPostResponse_XND {  responseFilename  } {
