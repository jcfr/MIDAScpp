...
//---------------------------------------------------------------------------
vtkStandardNewMacro (vtkFetchMIDASTagViewWidget );
vtkCxxRevisionMacro ( vtkFetchMIDASTagViewWidget, "$Revision$");


//---------------------------------------------------------------------------
vtkFetchMIDASTagViewWidget::vtkFetchMIDASTagViewWidget ( )
{
...
//---------------------------------------------------------------------------
void vtkFetchMIDASTagViewWidget::PrintSelf ( ostream& os, vtkIndent indent )
{
    this->vtkObject::PrintSelf ( os, indent );

    os << indent << "vtkFetchMIDASTagViewWidget: " << this->GetClassName ( ) << "\n";
...
//---------------------------------------------------------------------------
void vtkFetchMIDASTagViewWidget::Bind ( )
{
  if ( !this->IsCreated() )
    {
    return;
...
//---------------------------------------------------------------------------
void vtkFetchMIDASTagViewWidget::UnBind ( )
{
  if (!this->IsCreated() )
    {
    return;
...
//---------------------------------------------------------------------------
void vtkFetchMIDASTagViewWidget::DestroyTagViewWindow ( )
{
...
//---------------------------------------------------------------------------
void vtkFetchMIDASTagViewWidget::DisplayTagViewWindow ( )
{
...
//---------------------------------------------------------------------------
void vtkFetchMIDASTagViewWidget::SetTagText ( const char *text )
{
  this->TextBox->GetWidget()->SetText ( text );
}

//---------------------------------------------------------------------------
void vtkFetchMIDASTagViewWidget::SetTagTitle ( const char *title )
{
...
//---------------------------------------------------------------------------
void vtkFetchMIDASTagViewWidget::CreateWidget ( )
{
